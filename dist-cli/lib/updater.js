...
function getBundledPackagePath() {
    return fileURLToPath(new URL("../../package.json", import.meta.url));
}
async function readBundledPackageMetadata() {
    try {
...
async function writeUpdateCache(cache) {
...
async function runGlobalUpdate(packageName) {
...
export async function maybeRunStartupUpdate() {
