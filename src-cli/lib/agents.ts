...
export async function getAgentsStatus(cwd: string): Promise<AgentsStatus> {
...
export async function ensureGlobalAgentsLink(cwd: string): Promise<AgentsStatus> {
...
export async function ensureGlobalAgentsFile(): Promise<string> {
